m# tubeup --use-download-archive --metadata=collection:ytpmv-mad http://youtube.com/channel/UCGMA0oadw2XiglyjhlUDhRA ##Drug Store UTF-8 a constant uploading issue/videos
...
tubeup --use-download-archive --metadata=collection:ytpmv-mad http://youtube.com/channel/UCfCd7r58wCsgVidyPVbLAZAvideos
