...
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UC9k2WzcJ1kUMl4KIwNQwrFA ## creator:"Bloke on the Range"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UCCdeHKahyMAlPV6SQGx8psg ## creator:"80 Percent Arms"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UCClIfWXtn4rA-1jDHAVPYmg ## creator:"akbuilderDOTcom"
...
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UCiqYKuIJRIr2PEF2FOLFOew ## creator:"GEMTECH Silencer"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UCjjqH5ZKLkY_NQeY_YpCvrg ## creator:"GunCraft101"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/channel/UCrZCwEZ3MBBd-TUu4auQvxg ## creator:"Guy in a garage"
...
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/KnightsArmCo ## creator:"KnightArmCo"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/Magpul ## creator:"Magpul"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/Silencerco ## creator:"SilencerCo"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/StealthArms ## creator:"Stealth Arms"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/TweezerAddict ## creator:"The Unknown Cat"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/VuurwapenBlog ## creator:"VuurwapenBlog"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/aardvarkfarts ## creator:"gunthreadadapters.com"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/britishmuzzleloaders ## creator:"britishmuzzleloaders"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/capandball ## creator:"capandball"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/cyrusjj ## creator:"Dynamic Pie Concepts"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/derwoodvw ## creator:"derwoodvw"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/nsz85 ## creator:"nsz85"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/royalnonesuchshow ## creator:"Royal Nonesuch"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/saunixcomp ## creator:"NYC CNC"
python3.7 -m tubeup --use-download-archive --metadata=collection:tubeup http://youtube.com/user/tnoutdoors9 ## creator:"tnoutdoors9"
